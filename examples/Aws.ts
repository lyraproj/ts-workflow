...
import {Value} from '../src/pcore/Util';
...
export class BlockDeviceMapping implements PcoreValue {
  ...
  constructor({deviceName = '', ebs = null, noDevice = '', virtualName = ''}:
                  {deviceName?: string, ebs?: EbsBlockDevice|null, noDevice?: string, virtualName?: string}) {
...
export class CpuOptions implements PcoreValue {
  ...
  constructor({coreCount = 0, threadsPerCore = 0}: {coreCount?: number, threadsPerCore?: number}) {
...
export class GroupIdentifier implements PcoreValue {
  ...
  constructor({groupId = '', groupName = ''}: {groupId?: string, groupName?: string}) {
...
export class IamInstanceProfile implements PcoreValue {
  ...
  constructor({arn = '', name = '', id = ''}: {arn?: string, name?: string, id?: string}) {
    this.arn = arn;
    this.name = name;
    this.id = id;
  }
...
export class InternetGateway implements PcoreValue {
  ...
  constructor(
      {tags, internetGatewayId = null, attachments = []}:
          {tags: {[s: string]: string}, internetGatewayId?: string|null, attachments?: InternetGatewayAttachment[]}) {
    this.tags = tags;
...
export class IpRange implements PcoreValue {
  ...
  constructor({cidrIp = '', description = ''}: {cidrIp?: string, description?: string}) {
    this.cidrIp = cidrIp;
    this.description = description;
  }
...
export class Ipv6Range implements PcoreValue {
  ...
  constructor({cidrIpv6 = '', description = ''}: {cidrIpv6?: string, description?: string}) {
...
export class KeyPair implements PcoreValue {
  ...
  constructor({publicKeyMaterial, keyName, keyFingerprint = ''}:
                  {publicKeyMaterial: string, keyName: string, keyFingerprint?: string}) {
...
export class Monitoring implements PcoreValue {
  ...
  constructor({enabled = false, state = ''}: {enabled?: boolean, state?: string}) {
...
export class PrefixListId implements PcoreValue {
  ...
  constructor({description = '', prefixListId = ''}: {description?: string, prefixListId?: string}) {
    this.description = description;
...
export class ProductCode implements PcoreValue {
  ...
  constructor({productCodeId = '', productCodeType = ''}: {productCodeId?: string, productCodeType?: string}) {
...
export class RouteTableAssociation implements PcoreValue {
  ...
  constructor({main, routeTableId, subnetId, routeTableAssociationId = null}:
                  {main: boolean, routeTableId: string, subnetId: string, routeTableAssociationId?: string|null}) {
    this.main = main;
    this.routeTableId = routeTableId;
    this.subnetId = subnetId;
